...
class Student_mod extends CI_Model
{
    ...
    {
        $this->db->select('*,DATE_FORMAT(scheduled_class_date,"%d/%m/%Y") AS scheduled_class_date,DATE_FORMAT(actual_class_conducted_date,"%d/%m/%Y") AS actual_class_conducted_date');
    ...
    public function saveAttendance($attid,$clevid,$data){
