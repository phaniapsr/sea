                                ...
                                <table aria-describedby="dt-state-franchisee_info"
                                    ...
                                    <tr role="row">
                                        ...
                                        <th aria-label="Franchisee Id: activate to sort column ascending"
                                            ...
                                            class="selected sorting_asc">St Name
                                        </th>
                                        ...
                                        <th aria-label="Deactive" style="width: 108px;" colspan="1" rowspan="1"
                                            class="text-center sorting_disabled">UF Share
                                        </th>
                                        <th aria-label="Deactive" style="width: 108px;" colspan="1" rowspan="1"
                                    ...
                                    foreach ($data as $row) {
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td><?php echo $row['smf_amount']; ?></td>
                                            <td><?php echo $row['dmf_amount']; ?></td>
                                            <td><?php echo $row['uf_amount']; ?></td>
                                            <td><?php echo $row['consultant_amount']; ?></td>
                                            <td><?php echo $row['company_amount']; ?></td>
