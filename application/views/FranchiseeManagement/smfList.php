                                ...
                                <table aria-describedby="dt-state-franchisee_info"
                                    ...
                                    <tr role="row">
                                        ...
                                        <th aria-label="City: activate to sort column ascending" style="width: 108px;"
                                            colspan="1" rowspan="1"  class="text-center sorting_disabled" aria-controls="dt-state-franchisee" tabindex="0"
                                            class="sorting">City
                                        </th>
                                        <th aria-label="State: activate to sort column ascending" style="width: 108px;"
                                            colspan="1" rowspan="1" class="text-center sorting_disabled" aria-controls="dt-state-franchisee">State
                                        </th>
