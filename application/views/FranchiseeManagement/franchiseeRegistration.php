                ...
                <div class="panel panel-default">
                    <div id="margin-top" class="panel-body">
                        <form id="franchiseeRegistration"
                              action="<?php echo base_url() ?>FranchiseeManagement/registerFranchisee" name="form2"
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-5 col-lg-offset-1 control-label " style="text-align: left">Franchisee
                                            Name *</label>
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" name="franchiseeName"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="input-group input-append date" id="datePicker">
                                                <input type="text" class="form-control" name="date_of_birth"
                                                       id="datepicker-my" placeholder="DD/MM/YYYY" value="01/01/0001"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" name="OtherCompletedYear"
                                                   placeholder="Completed in year" value="0"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
