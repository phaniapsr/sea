                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div id="margin-top" class="panel-body">
                            <form id="form2" name="form2" class="form-horizontal" method="POST" ng-app="app" ng-controller="Ctrl" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <select class="form-control" name="FranchiseeTypeId">
                                                    ...
                                                    <option value="1">State Master Franchisee</option>
                                                    <option value="2">District Master Franchisee</option>
                                                    <option value="3">Unit Franchisee</option>
                                                </select>

                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-5 col-lg-offset-1 control-label " style="text-align: left">Login Name *</label>
                                            <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-group input-append date" id="datePicker">
                                                    <input type="text" class="form-control" name="" id="datepicker-my" placeholder="DD/MM/YYYY" value="01/01/0001" />
